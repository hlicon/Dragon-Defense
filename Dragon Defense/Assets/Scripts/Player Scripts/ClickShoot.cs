...
public class ClickShoot : MonoBehaviour
{
	...
	[Header (" ")]
	public UpgradeManager[] upgradeManagers;
	...
	public void GetSelection (int newSelection)
	{ //Setting selection to the selected shot in the Shots array
