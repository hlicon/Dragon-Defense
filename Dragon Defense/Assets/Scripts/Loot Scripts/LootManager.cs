...
public class LootManager : MonoBehaviour {
	...
	void Start () {
		...
		contentPanelRect = contentPanel.GetComponent<RectTransform>();
	...
	public void DisplayLoot() {
		...
		while (lootList.Count > 0) {
			...
			nextItem.transform.SetParent (contentPanelRect, false);
		}
	}
